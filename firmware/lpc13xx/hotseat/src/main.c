...
static const uint32_t xxtea_key[XXTEA_BLOCK_COUNT] = { 0x00112233, 0x44556677, 0x8899AABB, 0xCCDDEEFF };
...
main (void)
{
  ...
  /* blink three times to indicate initialized RF interface */
  blink (3);
